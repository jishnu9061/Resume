	...
	<div id="fh5co-about" class="animate-box">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="info">
						<li><span class="first-block">Full Name:</span><span class="second-block">Jishnu Ganesh</span></li>
						<li><span class="first-block">Phone:</span><span class="second-block">+ 91 9061670329</span></li>
						<li><span class="first-block">Email:</span><span class="second-block">jishnuganesh27@gmail.com</span></li>
						<li><span class="first-block">Website:</span><span class="second-block">#</span></li>
						<li><span class="first-block">Address:</span><span class="second-block">Nandanam Near S S Temple Payyanur 670307</span></li>
					</ul>
				</div>
				<div class="col-md-8">
					<h2>Hello There!</h2>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="https://www.rosegreenusa.com/" class="work" target="_blank" style="background-image: url(images/rosegreen.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Rosegreen</span>
						</div>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="https://workforce.huntr.app/" class="work" target="_blank" style="background-image: url(images/huntr.png);">
						<div class="desc">
							<h3>Project Name</h3>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="https://play.google.com/store/search?q=eduwizz&c=apps" target="_blank" class="work" style="background-image: url(images/eduwiz.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Eduwizz</span>
						</div>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="#" class="work" target="_blank" style="background-image: url(images/avani.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Avani Bms</span>
						</div>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="https://www.focus-training.com.au/" class="work" target="_blank" style="background-image: url(images/focus.png);">
						<div class="desc">
							<h3>Project Name</h3>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="https://booking.thegatehotel.net/" class="work" target="_blank" style="background-image: url(images/thegatehotel.png);">
						<div class="desc">
							<h3>Project Name</h3>
				...
				<div class="col-md-3 text-center col-padding animate-box">
					<a href="https://huntr.app/admin/login" class="work" target="_blank" style="background-image: url(images/huntr.png);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Huntr</span>
						</div>
